...
def main(ctx):
  ...
  linux_cxx("Clang 11", "clang++-11", packages="clang-11 libstdc++-9-dev", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu1804:1", environment={'VARIANT': 'release', 'TOOLSET': 'clang', 'COMPILER': 'clang++-11', 'CXXSTD': '17,2a'}, globalenv=globalenv),
