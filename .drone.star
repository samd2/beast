...
def main(ctx):
  ...
  linux_cxx("GCC 6.0, Debug + Coverage", "g++-6", packages="g++-6 libssl-dev", image="cppalliance/droneubuntu1604:1", buildtype="boost_v1", buildscript="drone", environment={"VARIANT": "beast_coverage", "TOOLSET": "gcc", "COMPILER": "g++-6", "CXXSTD": "14", "DRONE_BEFORE_INSTALL" : "beast_coverage", "CODECOV_TOKEN": {"from_secret": "codecov_token"}}, globalenv=globalenv, privileged=True),
    ...
    linux_cxx("GCC Valgrind", "g++", packages="g++-7 libssl-dev valgrind", image="ubuntu:20.04", buildtype="boost_v1", buildscript="drone", environment={ "VARIANT": "beast_valgrind", "TOOLSET": "gcc", "COMPILER": "g++", "CXXSTD": "11" }, globalenv=globalenv),
