...
def main(ctx):
  ...
  linux_cxx("GCC Valgrind original 1", "g++", packages="g++-7 libssl-dev valgrind libc6-dbg", image="cppalliance/droneubuntu2004:1", buildtype="valgrind_v1", buildscript="drone", environment={ "VARIANT": "beast_valgrind", "TOOLSET": "gcc-7", "CXXSTD": "11" }),
  # valgrind alternative/experimental
  # linux_cxx("valgrind", "clang++-6.0", packages="clang-6.0 libc6-dbg libc++-dev libstdc++-8-dev", llvm_os="bionic", llvm_ver="6.0", buildtype="valgrind_v2", buildscript="drone", image=linuxglobalimage, environment={'COMMENT': 'valgrind', 'B2_TOOLSET': 'clang-6.0', 'B2_CXXSTD': '11,14', 'B2_DEFINES': 'BOOST_NO_STRESS_TEST=1', 'B2_VARIANT': 'debug', 'B2_TESTFLAGS': 'testing.launcher=valgrind', 'VALGRIND_OPTS': '--track-origins=yes --max-stackframe=16000000 --error-exitcode=1', 'DRONE_JOB_UUID': '1b64538924'}, globalenv=globalenv),
