...
def main(ctx):
  return [
#  linux_cxx("codecov", "g++-8", packages="g++-8", buildtype="codecov", buildscript="drone", image=linuxglobalimage, environment={'COMMENT': 'codecov.io', 'B2_CXXSTD': '11', 'B2_TOOLSET': 'gcc-8', 'B2_DEFINES': 'BOOST_NO_STRESS_TEST=1', 'DRONE_JOB_UUID': 'b6589fc6ab'}, globalenv=globalenv),
...
#  linux_cxx("ubsan", "g++-8", packages="g++-8", buildtype="boost", buildscript="drone", image=linuxglobalimage, environment={'COMMENT': 'ubsan', 'B2_VARIANT': 'debug', 'B2_TOOLSET': 'gcc-8', 'B2_CXXSTD': '11,14', 'B2_UBSAN': '1', 'B2_DEFINES': 'BOOST_NO_STRESS_TEST=1', 'B2_LINKFLAGS': '-fuse-ld=gold', 'DRONE_JOB_UUID': '77de68daec'}, globalenv=globalenv),
  ...
  linux_cxx("GCC Valgrind original 1", "g++", packages="g++-7 libssl-dev valgrind libc6-dbg", image="cppalliance/droneubuntu2004:1", buildtype="valgrind_original", buildscript="drone", environment={ "BEAST_RETRY": False, "VARIANT": "beast_valgrind", "TOOLSET": "gcc-7", "CXXSTD": "11" }),
  # classic. New candidate.
  linux_cxx("GCC Valgrind original 2", "g++", packages="g++-7 libssl-dev valgrind libc6-dbg", image="cppalliance/droneubuntu2004:1", buildtype="valgrind_original", buildscript="drone", environment={ "BEAST_RETRY": False, "B2_VARIANT": "beast_valgrind", "B2_TOOLSET": "gcc-7", "B2_CXXSTD": "11" }),
  # classic. New candidate.
  linux_cxx("GCC Valgrind original 3", "g++", packages="g++-7 libssl-dev valgrind libc6-dbg", image="cppalliance/droneubuntu2004:1", buildtype="valgrind_original", buildscript="drone", environment={ "BEAST_RETRY": False, "B2_VARIANT": "beast_valgrind", "VARIANT": "beast_valgrind", "B2_TOOLSET": "gcc-7", "B2_CXXSTD": "11" }),
  # "hybrid" invention
  ...
  # "hybrid" invention without error-exitcode
   linux_cxx("GCC Valgrind 3", "g++", packages="g++-7 libssl-dev valgrind libc6-dbg", image="cppalliance/droneubuntu2004:1", buildtype="boost", buildscript="drone", environment={ "B2_VARIANT": "beast_valgrind", "B2_COMPILER": "g++",'B2_TOOLSET': 'gcc-7', 'B2_CXXSTD': '11,14', 'B2_DEFINES': 'BOOST_NO_STRESS_TEST=1', 'B2_TESTFLAGS': 'testing.launcher=valgrind', 'DRONE_JOB_UUID': '1b64538924' }),
