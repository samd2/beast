...
def main(ctx):
  ...
  linux_cxx("GCC 11, C++17, libstdc++, release", "g++-11", packages="g++-11 mlocate", image="cppalliance/droneubuntu2204:1", buildtype="boost_v1", buildscript="drone", environment={  "VARIANT": "release", "TOOLSET": "gcc", "COMPILER": "g++-11", "CXXSTD" : "17" }, globalenv=globalenv),
