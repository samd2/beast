...
def main(ctx):
  ...
  osx_cxx("clang xcode 13.4", "g++", packages="", buildtype="boost", buildscript="drone", xcode_version="13.4", environment={'B2_TOOLSET': 'clang', 'B2_CXXSTD': '11,17'}, globalenv=globalenv),
  osx_cxx("clang xcode 13.3", "g++", packages="", buildtype="boost", buildscript="drone", xcode_version="13.3", environment={'B2_TOOLSET': 'clang', 'B2_CXXSTD': '11,17'}, globalenv=globalenv),
  osx_cxx("clang xcode 13.2", "g++", packages="", buildtype="boost", buildscript="drone", xcode_version="13.2", environment={'B2_TOOLSET': 'clang', 'B2_CXXSTD': '11,17'}, globalenv=globalenv),
  osx_cxx("clang xcode 12.5", "g++", packages="", buildtype="boost", buildscript="drone", xcode_version="12.5", environment={'B2_TOOLSET': 'clang', 'B2_CXXSTD': '11,17'}, globalenv=globalenv),
